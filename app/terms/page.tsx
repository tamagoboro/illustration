      ...
      <div className="max-w-3xl mx-auto bg-white p-6 sm:p-10 rounded-2xl shadow-sm border border-slate-200/80 space-y-6">
        ...
        <div className="border-b border-slate-100 pb-4 flex justify-between items-center">
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1">制定日: 2026年8月25日　最終改定日: 2026年9月21日</p>
          </div>
        ...
        <div className="space-y-6 text-xs text-slate-700 leading-relaxed">
          ...
          <section className="space-y-1.5">
            ...
            <ol className="list-decimal list-inside space-y-1 pl-1">
              ...
              <li>ユーザーがプロフィール上に任意で掲載する電子メールアドレスその他の外部連絡先（SNSアカウント等）を通じて行われるやり取りについても、当方はその内容、真正性および結果について一切の責任を負いません。ユーザーは、自己の判断と責任において当該連絡先を掲載・利用するものとします。</li>
            </ol>
          </section>

          <section className="space-y-1.5">
            <h2 className="font-bold text-slate-900 text-sm">第4条（リクエスト機能について）</h2>
            <ol className="list-decimal list-inside space-y-1 pl-1">
              <li>本サービスは、クライアントがクリエイターに対し、料金メニューまたは見積もりフォームに定めのない依頼内容を直接送信できる「リクエスト機能」を提供する場合があります。</li>
              <li>クリエイターは、送信されたリクエストの内容を確認のうえ、これを承諾または辞退するかを自由に判断できるものとします。リクエストの送信自体は、当方またはクリエイターに対しいかなる契約上の義務も生じさせないものとします。</li>
              <li>リクエストが承諾された場合であっても、その後の具体的な取引条件（料金、納期、成果物の内容等）は当事者間で別途合意するものとし、前条（第3条）の定めが適用されます。</li>
              <li>ユーザーは、過度に大量のリクエストを送信する行為、その他リクエスト機能を悪用する行為をしてはならないものとします。</li>
            </ol>
          </section>

          <section className="space-y-1.5">
            <h2 className="font-bold text-slate-900 text-sm">第5条（禁止事項）</h2>
            ...
            <ul className="list-disc list-inside space-y-1 pl-2 text-slate-600">
              ...
              <li>虚偽の事実に基づく通報、または他のユーザーを害する目的での通報機能の悪用</li>
          ...
          <section className="space-y-1.5">
            <h2 className="font-bold text-slate-900 text-sm">第6条（本サービスの提供の停止等）</h2>
          ...
          <section className="space-y-1.5">
            <h2 className="font-bold text-slate-900 text-sm">第7条（権利帰属）</h2>
            <ol className="list-decimal list-inside space-y-1 pl-1">
              <li>本サービス上のテキスト、画像、プログラム等に関する知的財産権は、当方または正当な権利を有する第三者に帰属します。</li>
              <li>クリエイターが登録・投稿したポートフォリオ画像、プロフィールアイコン画像等の著作権は、各クリエイター本人に帰属します。ただし、クリエイターは、当方が本サービスのPRやプロモーションを目的として、該当画像をサービス内やSNS等で無償で使用することを許諾するものとします。</li>
              <li>当方は、掲載された画像の無断複製・転載を抑止する目的で、電子透かしの表示、右クリック操作の制限その他の技術的措置を講じることがあります。ただし、これらの措置により無断複製・転載等を完全に防止できることを保証するものではありません。</li>
            </ol>
          </section>

          {/* 新設：イラストの真正性と検証に関する規定 */}
          <section className="space-y-1.5">
            <h2 className="font-bold text-slate-900 text-sm">第8条（掲載コンテンツの真正性と証明）</h2>
            <ol className="list-decimal list-inside space-y-1 pl-1">
          ...
          <section className="space-y-1.5">
            <h2 className="font-bold text-slate-900 text-sm">第9条（通報機能について）</h2>
            <ol className="list-decimal list-inside space-y-1 pl-1">
              <li>当方は、ユーザーが他のユーザーのプロフィールまたは投稿コンテンツについて、本規約違反、著作権侵害その他不適切な内容の疑いがあると判断した場合に、当方へ通報できる機能を提供する場合があります。</li>
              <li>当方は、通報を受けた場合、その内容を確認のうえ、必要と判断したときは、該当コンテンツの削除、アカウントの利用制限その他当方が適当と判断する措置を講じることができるものとします。ただし、当方はすべての通報について調査・対応することを保証するものではありません。</li>
              <li>通報者および被通報者の情報は、対応に必要な範囲でのみ利用し、みだりに第三者へ開示しないものとします。</li>
            </ol>
          </section>

          <section className="space-y-1.5">
            <h2 className="font-bold text-slate-900 text-sm">第10条（免責事項）</h2>
            <ol className="list-decimal list-inside space-y-1 pl-1">
          ...
          <section className="space-y-1.5">
            <h2 className="font-bold text-slate-900 text-sm">第11条（利用規約の変更）</h2>
            <p>当方は、必要と判断した場合には、ユーザーに通知することなくいつでも本規約を変更することができるものとします。なお、変更後の本規約は、本サービス上に掲示された時点から効力を生じるものとします。</p>
          </section>

          <section className="space-y-1.5">
            <h2 className="font-bold text-slate-900 text-sm">第12条（準拠法・裁判管轄）</h2>
            <ol className="list-decimal list-inside space-y-1 pl-1">
